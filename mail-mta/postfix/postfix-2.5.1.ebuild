...
# regular ebuild
IUSE="cdb dovecot-sasl hardened ipv6 ldap mailwrapper mbox mysql nis pam
	postgres sasl selinux ssl vda srs"
# mailer-config support
...
DEPEND=">=sys-libs/db-3.2
		...
		srs? ( >=mail-filter/libsrs2-1.0.18 )"
