...
src_unpack() {
	...
	EPATCH_EXCLUDE="020_all_heimdal-0.9rc1-ntlm-global.patch \
	005_all_heimdal-suid_fix.patch \
	010_all_heimdal-system-libss.patch \
	010_all_heimdal-0.9rc1-system-libss.patch"
	EPATCH_SUFFIX="patch" epatch "${FILESDIR}"/patches

	# higher number than app-crypt/libgssapi
	sed -i -e 's/libgssapi_la_LDFLAGS = -version-info 1:0:0/libgssapi_la_LDFLAGS = -version-info 3:0:0/' lib/gssapi/Makefile.am
...
src_install() {
	...
	mv ${D}/usr/bin/mk_cmds ${D}/usr/bin/mk_cmds.heimdal
...
#	dolib lib/kadm5/sample_passwd_check.so
	...
	dosym heimdal/gssapi.h /usr/include/gssapi.h
