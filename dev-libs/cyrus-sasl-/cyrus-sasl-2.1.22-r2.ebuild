...
SRC_URI="ftp://ftp.andrew.cmu.edu/pub/cyrus-mail/${P}.tar.gz
		...
		http://surf.org.uk/downloads/ldapauxprop.tgz"
LICENSE="as-is"
SLOT="2"
...
src_unpack() {
	...
	if use ldap; then
		epatch "${FILESDIR}/${P}-ldapauxprop.patch"
	fi
...
src_compile() {
	...
	myconf="${myconf} `use_with ldap ldapauxprop`"
...
src_install() {
	...
	docinto ldap_auxprop
	dodoc ../ldap_auxprop_sasl-2/{ChangeLog,README}
