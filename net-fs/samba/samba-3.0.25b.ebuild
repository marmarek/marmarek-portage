...
#done in 3.0.25	epatch "${FILESDIR}/${PV}-sid2name_elevation_v2.patch"
#done in 3.0.25	epatch "${FILESDIR}/${PV}-shell_escape.patch"
#done in 3.0.25	epatch "${FILESDIR}/${PV}-heap_overflow_v2.patch"

	rm ${PATCHDIR}/general/010_all_samba-3.0.x-extrabins.patch
	rm ${PATCHDIR}/general/011_all_samba-3.0.x-subins-configure.patch
	rm ${PATCHDIR}/general/012_all_samba-3.0.x-subins-makefile.patch #TODO
