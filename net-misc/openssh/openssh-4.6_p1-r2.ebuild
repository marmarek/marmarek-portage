...
LDAP_PATCH="${PARCH/-4.6p1/-lpk-4.6p1}-0.3.9.patch"
...
src_unpack() {
	...
	#marmarek
	epatch "${FILESDIR}"/${PN}-4.4_p1-szpajder-ole.patch
	if use ldap ; then
		epatch "${FILESDIR}"/${PN}-4.6_p1-secure-rsa-and-pubkey-auth-ldap.diff
	else
