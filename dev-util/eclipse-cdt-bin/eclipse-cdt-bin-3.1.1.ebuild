...
SRC_URI="amd64? ( http://download.eclipse.org/tools/cdt/releases/callisto/dist/${PV}/org.eclipse.cdt-${PV}-linux.x86_64.tar.gz )
x86? ( http://download.eclipse.org/tools/cdt/releases/callisto/dist/${PV}/org.eclipse.cdt-${PV}-linux.x86.tar.gz )"
...
src_install () {
	cd "${S}"
	eclipse-ext_require-slot 3.2 || die \
